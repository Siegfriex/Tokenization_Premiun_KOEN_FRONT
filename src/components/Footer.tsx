      ...
      <Container className="space-y-12">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 border-b border-rule pb-8">
          <div className="space-y-2">
            ...
            <p className="text-ink-body text-xs max-w-xl">
              {isKo
          ...
          <div className="flex flex-wrap items-center gap-3 font-mono text-[11px]">
            <span className="px-3 py-1 bg-surface-alt border border-rule rounded-xs text-ink-body">
              Tokenizer: o200k_base
            </span>
            <span className="px-3 py-1 bg-accent border border-accent rounded-xs text-on-accent font-bold">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-2">
            <h4 className="font-mono font-bold text-ink uppercase tracking-wider text-[11px] flex items-center gap-1.5">
        ...
        {/* Bottom Copyright */}
        <div className="border-t border-rule pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-[11px] text-ink-muted font-mono">
          <div>
