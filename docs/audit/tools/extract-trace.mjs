...
const PRIMITIVE_DOM = {
  ...
  ArticleFullWidthBreak: { role: 'full-width-break', tag: 'figure|div', base: 'renders <figure> when the `figure` prop is set, else a wide Container div' },
  ...
  ArticleFigureCaption: { role: 'figure-caption', tag: 'figcaption', base: 'pt-3 space-y-1 text-xs font-mono' },
