...
|---|---|---|---|---|
| `HERO-025` | NewsHeroSection | 120 | 31 TOKENS `31 TOKENS` | **observed:** markup renders "31 TOKENS" for the Korean exhibit row<br>**entity:** no CURATED_PAIRED_SENTENCES entry has hangulCount 31; TOKEN_BASELINE_SIMULATION.baseKoPerPrompt is 31 |
...
|---|---|---|---|---|
| `METH-008` | MethodSection | 73 | 6 Key Principles `6 Key` | 6 Key also at src/entities/sentence-pair/content/sentence-pair.ts:23 |
